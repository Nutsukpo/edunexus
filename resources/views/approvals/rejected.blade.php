...
@section('title', 'Rejected Lesson Notes')

@section('content')
<div class="container">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1>Rejected Lesson Notes</h1>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('lesson-notes.approvals.rejected') }}" class="row g-3">
                <div class="col-md-3">
        ...
        <div class="card-body">
                        ...
                        <tbody>
                            @foreach($lessonNotes as $index => $note)
                                <tr>
                                    ...
                                    <td>{{ $note->rejected_at ? $note->rejected_at->format('d/m/Y H:i') : 'N/A' }}</td>
                                    <td>
            ...
            @else
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> No rejected lesson notes found.
                </div>
            @endif
        </div>
    </div>
