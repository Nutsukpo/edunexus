...
@section('title', 'Student Grievance Management')
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="mt-2 mt-md-0">
                            <a href="{{ route('student-grievance.create') }}" class="btn btn-primary">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="{{ route('student-grievance.index') }}" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                ...
                                <a href="{{ route('student-grievance.index', ['status' => 'submitted']) }}" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                ...
                                <a href="{{ route('student-grievance.index', ['status' => 'resolved']) }}" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('student-grievance.index', ['status' => 'rejected']) }}" class="small-box-footer">
                            ...
                            <div class="card card-outline card-light">
                                <div class="card-header">
                                    <h6 class="card-title mb-0">
                                        <i class="fas fa-filter"></i> Filter Grievances
                                    </h6>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('student-grievance.index') }}" method="GET" id="filterForm">
                                        <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-1">
                                            @if($grievance->is_anonymous)
                                                <span class="badge badge-secondary" title="Anonymous">
                                                    <i class="fas fa-user-secret"></i> Anonymous
                                                </span>
                                            @endif
                                            @if($grievance->is_confidential)
                                                <span class="badge badge-info" title="Confidential">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <div>
                                                <strong>{{ $grievance->student->full_name ?? 'N/A' }}</strong>
                                                @if($grievance->student)
                                                    <br>
                                                    <small class="text-muted">{{ $grievance->student->student_number ?? '' }}</small>
                                                @endif
                                            </div>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <span class="badge badge-{{ $grievance->priority_badge }} badge-pill">
                                    ...
                                    <td>
                                        <span class="badge badge-{{ $grievance->status_badge }} badge-pill">
                                    ...
                                    <td>
                                        <div title="{{ $grievance->created_at->format('l, d F Y h:i A') }}">
                                            ...
                                            <small class="text-muted">
                                                <i class="fas fa-clock"></i> 
                                                {{ $grievance->created_at->diffForHumans() }}
                                            </small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('student-grievance.show', $grievance->id) }}" 
                                               class="btn btn-info" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @if($grievance->canEdit())
                                                <a href="{{ route('student-grievance.edit', $grievance->id) }}" 
    ...
    $(document).ready(function() {
        ...
        window.confirmDelete = function(id) {
            if (confirm('Are you sure you want to delete this grievance? This action cannot be undone.')) {
                document.getElementById('delete-form').action = '{{ url("student-grievance") }}/' + id;
        ...
        window.appealGrievance = function(id) {
            if (confirm('Are you sure you want to appeal this grievance? This will reopen it for review.')) {
                document.getElementById('appeal-form').action = '{{ url("student-grievance") }}/' + id + '/appeal';
        ...
        $('#clearFilters').click(function() {
            window.location.href = '{{ route("student-grievance.index") }}';
        });
