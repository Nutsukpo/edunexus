            ...
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h3 class="card-title mb-0">
                                <i class="fas fa-plus-circle text-primary"></i> Submit Grievance
                            </h3>
                ...
                <form action="{{ route('grievance.store') }}" method="POST" enctype="multipart/form-data" id="grievanceForm">
                                ...
                                <div class="alert alert-info border-left-info">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <ol class="mb-0 pl-3">
                                                <li>Your grievance will be reviewed by the HR department</li>
                                                <li>You will receive a confirmation email with your grievance code</li>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('grievance.index') }}" class="btn btn-danger">
...
<script>
    $(document).ready(function() {
        ...
        var autoSaveTimer;
        $('#grievanceForm input, #grievanceForm textarea, #grievanceForm select').on('change keyup', function() {
            clearTimeout(autoSaveTimer);
            autoSaveTimer = setTimeout(function() {
                // Auto-save draft logic - you can implement via AJAX
                if (typeof toastr !== 'undefined') {
                    toastr.info('Auto-saving draft...');
                }
