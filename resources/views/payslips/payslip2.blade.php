...
<body style="font-family: 'DejaVu Sans', sans-serif; padding: 20px; background: #ffffff; color: #333333; font-size: 12px; margin: 0;">
    
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 1000px; margin: 0 auto; border: 1px solid #dddddd; padding: 30px; background: #ffffff;">
        <tr>
            <td>
                <!-- Print Date -->
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 3px solid #1a73e8; padding-bottom: 15px; margin-bottom: 20px;">
                    <tr>
                        ...
                        <td align="right" style="width: 50%; font-size: 11px; color: #666666;">
                            ...
                            {{ config('app.address', 'Company Address') }}
                        </td>
                    </tr>
                </table>
