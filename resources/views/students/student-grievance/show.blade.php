...
@section('title', 'Edit Student Grievance')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">
                            <i class="fas fa-edit text-warning"></i> Edit Student Grievance
                        </h3>
                        <div>
                            <a href="{{ route('student-grievance.show', $grievance->id) }}" class="btn btn-secondary btn-sm">
                ...
                <!-- /.card-header -->
                <form action="{{ route('student-grievance.update', $grievance->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if($errors->any())
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="class_id" id="class_id" 
                                        ...
                                        @foreach($classes as $class)
                                            <option value="{{ $class->id }}" {{ old('class_id', $grievance->class_id) == $class->id ? 'selected' : '' }}>
                                                {{ $class->name }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('student-grievance.show', $grievance->id) }}" class="btn btn-secondary">
